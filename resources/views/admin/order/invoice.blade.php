    ...
    <section class="card">
        <div class="card-body">
            ...
            <div class="text-right mr-4">
                <a href="{{route('invoice-print',\Illuminate\Support\Facades\Crypt::encryptString($invoices->id))}}" target="_blank" class="btn btn-primary ml-3"><i class="fas fa-print"></i> Print</a>
            </div>
        </div>
    </section>
