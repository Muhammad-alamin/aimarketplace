                ...
                <div class="row">
                    <div class="col-lg-3">
                        <ul class="nav nav-tabs faq-page__links ">
                            <li class="nav-item">
                                <a data-toggle="tab" href="#profile" class="nav-link active">Profile</a>
                            </li>
                            <li class="nav-item">
                                <a data-toggle="tab" href="#orders" class="nav-link">Orders</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="col-lg-9">
                        <div class="tab-content">
                                                ...
                                                <div class="card-body">
                                                    <form role="form" method="POST" action="{{ route('admin.profile.update', encrypt(auth()->user()->id)) }}" class="needs-validation">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input type="tetx" class="form-control" name="phone" id="phone" value="{{old('phone', isset(auth()->user()->phone)?auth()->user()->phone:null)}}" placeholder="Enter User Phone">
                            ...
                            <div class="tab-pane animated fadeInRight" id="orders">
                                <div class="accrodion-grp" data-grp-name="faq-page__accrodion">
                                    <div class="accrodion active">
                                        <div class="accrodion-title">
                                            <h4>Orders</h4>
                                                    ...
                                                    <table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="nk-tb-item">
                                                                ...
                                                                <td class="actions">
                                                                    <a href="{{route('customer.orders.details',encrypt($order->id))}}" class="">Details</a>
                                                                </td>
                                                            </tr><!-- .nk-tb-item  -->
                                                        @endforeach
                                                        </tbody>
                            ...
                            </div><!-- /#museum.tab-pane animated fadeInRight -->
                        </div><!-- /.tab-content -->
                    </div><!-- /.col-lg-9 -->
                </div><!-- /.row -->
            </div><!-- /.container -->
